...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen w-full relative flex items-center justify-center p-4 bg-[#080214] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        {/* Center / Bottom Right Purple Wave Ribbons */}
      ...
      {/* Glassmorphic Card Container (Matching Reference 100%) */}
      <div className="relative z-10 w-full max-w-[390px] sm:max-w-[430px] rounded-[38px] p-7 sm:p-10 backdrop-blur-2xl bg-white/[0.04] border border-white/20 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.25)] flex flex-col my-8">
        
        {/* Header Logo */}
        <div className="flex flex-col items-center mb-6">
          {/* Two Diagonal Capsule Logo Mark */}
